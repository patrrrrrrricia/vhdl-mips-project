...
* **`tb`**: Testbench-uri pentru verificarea corectitudinii algoritmului de analiză.
* **`8-documentatie`**: Tabele de semnale de control, diagrame RTL și documentația logică a problemei.

---

### Visual Documentation

| Arhitectură Pipeline | Schema RTL & Logica |
| :---: | :---: |
| <img width="400" src="AICI_PUNE_LINK_IMAGINE_PIPELINE" /> | <img width="400" src="AICI_PUNE_LINK_IMAGINE_RTL" /> |
